    ...
    <section class="products" style="padding-top: 0;">
        ...
        <div class="box-container">
            ...
            if (isset($_POST['search_btn'])) {
                ...
                $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE product_keywords LIKE '%{$search_box}%'") or die('query failed');
            ...
            ?>
                        <form action="" method="POST" class="box">
                            ...
                            <input type="hidden" name="product_keywords" value="<?php echo $fetch_products['product_keywords']; ?>">
                            <input type="hidden" name="product_title" value="<?php echo $fetch_products['product_title']; ?>">
