    ...
    <section class="quick-view">
        ...
        ?>
                    <form action="" method="POST">
                        ...
                        <div class="details"><?php echo $fetch_products['product_description']; ?></div>
                        <?php
                        if ($fetch_products["quantity"] == 0) {
                            echo '<h1 style = "color:var(--red);">Out of Stock</h1>';
                        } else {
                            echo '<h1 style = "color:var(--brown);">Available</h1>';
                            echo '<input type="number" name="product_quantity" value ="1" min="0" max="' . $fetch_products['quantity'] . '" class="qty">';
                        }
                        ?>
        ...
        <div class="more-btn">
            <a href="home.php" class="option-btn">Go to Homepage</a>
        </div>
